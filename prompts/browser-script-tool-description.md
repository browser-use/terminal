...
- For audits after a large result, prefer a small independent sample/count/schema check plus one targeted repair pass. Do not repeatedly rerun the full crawl or full detail scrape when the site gives inconsistent counts or intermittent empty pages; save the best artifact, record the evidence, and finalize or explicitly mark the remaining gap.
